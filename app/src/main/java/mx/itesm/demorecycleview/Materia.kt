...
class Materia (val clave: String, val nombre: String, val descripcion: String)
{
    companion object {
        val arrMaterias = arrayOf(
            Materia("TC1014", "Fundamentos de programación",
                "Objetivo general:\n" +
            ...
            Materia("TC1018", "Estructura de datos", "Objetivo general:\n" +
            ...
            Materia("TC2025", "Programación avanzada", "Objetivo general:\n" +
            ...
            Materia("TI2011", "Evaluación y administración de proyectos", "Objetivo general:\n" +
